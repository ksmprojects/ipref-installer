...
<body style="font-family: 'Istok Web', sans-serif;">
	<div data-role="page" data-theme="a" id="demo-page">
		...
		<div data-role="content" data-theme="" role="main">
			<center>
				<h2>Live Updates:</h2>
				<a class="twitter-timeline" href="https://twitter.com/iprefsinstaller?ref_src=twsrc%5Etfw">Tweets by iprefsinstaller</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
		</div>
