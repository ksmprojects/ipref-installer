...
function setupApps(){
	...
	database.ref('gba4ios').set({
		name: "GBA4iOS",
		url: "itms-services://?action=download-manifest&url=https://iprefs.tk/api/gba4ios.plist",
		dev: "kmtech",
	...
	localStorage.setItem("gba4ios", "itms-services://?action=download-manifest&url=https://iprefs.tk/api/gba4ios.plist");
